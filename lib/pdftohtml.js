    ...
    return new Promise(function (resolve, reject) {
      ...
      child.on('close', (code) => {
        if (code === 0) {
          ...
          console.warn('Sorry, this script requires pdf2htmlEX. Please make sure its already installed.');
          console.warn('Install it from http://github.com/coolwanglu/pdf2htmlEX');
          reject({code: code});
        }
      });
    });
